...
export default function Donate() {
  ...
  return (
    <LazyMotion features={loadFeatures}>
      <div className="w-full h-full relative flex flex-col md:flex-row justify-start md:justify-between items-center py-6 md:py-8 lg:py-16 px-2 md:px-10 md:gap-6 lg:px-20 bg-gradient-to-b from-azure to-white">
